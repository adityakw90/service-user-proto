...
func (x *DeleteRequest) Reset() {
	*x = DeleteRequest{}
	mi := &file_user_device_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DeleteRequest) Descriptor() ([]byte, []int) {
	return file_user_device_proto_rawDescGZIP(), []int{5}
}
...
const file_user_device_proto_rawDesc = "" +
	"\n" +
	"\x11user/device.proto\x12\vuser.device\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x11user/common.proto\"\xd8\x01\n" +
	"\x06Device\x12\x10\n" +
...
var file_user_device_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
...
func file_user_device_proto_init() {
	...
	file_user_device_proto_msgTypes[0].OneofWrappers = []any{}
	file_user_device_proto_msgTypes[2].OneofWrappers = []any{}
	type x struct{}
